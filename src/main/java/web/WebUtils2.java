...
public class WebUtils2 {
    ...
    public static String getSessionTrace(HttpServletRequest request){
        ...
        authToken = WebUtils2.getCookie(request, AUTH_COOKIE);
        if(authToken != null){
            return authToken;
        }
    ...
    public static long ip2Long(String ip){
        ...
        long ipLong = 256*256*256*Integer.parseInt(phases[0])
                + 256*256*Integer.parseInt(phases[1])
                + 256*Integer.parseInt(phases[2])
                + Integer.parseInt(phases[3]);
        return ipLong;
    }

    private static final long a1 = ip2Long("10.0.0.0");
    private static final long a2 = ip2Long("10.255.255.255");
    private static final long b1 = ip2Long("172.16.0.0");
    private static final long b2 = ip2Long("172.31.255.255");
    private static final long c1 = ip2Long("192.168.0.0");
    private static final long c2 = ip2Long("192.168.255.255");
    ...
    public static boolean isIntranet(String ip){
        ...
        return (i>=a1 && i<=a2)||(i>=b1 && i<=b2)||(i>=c1 && i<=c2);
    }
}
